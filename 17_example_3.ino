...
#define _DUTY_MIN 560   // servo full clock-wise position (0 degree)
#define _DUTY_NEU 1510  // servo neutral position (90 degree)
#define _DUTY_MAX 2460  // servo full counter-clockwise position (180 degree)
