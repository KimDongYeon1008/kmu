...
#define _DUTY_MAX 2460 // 2000
#define _DUTY_NEU 1710 // 1580
#define _DUTY_MIN 560 // 1000

#define _SERVO_ANGLE_DIFF  150  // Replace with |D - E| degree
#define _SERVO_SPEED       700  // servo speed
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(100, 0.8, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return 902 + -4.52 * pow(a_value, 1) + 8.15E-03 * pow(a_value, 2) + -5.14E-06 * pow(a_value, 3);
}
